 ...
 */
class Carte extends \LoveLetter\PlatformBundle\Entity\Carte implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'LoveLetter\\PlatformBundle\\Entity\\Carte' . "\0" . 'id', '' . "\0" . 'LoveLetter\\PlatformBundle\\Entity\\Carte' . "\0" . 'nom', '' . "\0" . 'LoveLetter\\PlatformBundle\\Entity\\Carte' . "\0" . 'url', '' . "\0" . 'LoveLetter\\PlatformBundle\\Entity\\Carte' . "\0" . 'nombre', '' . "\0" . 'LoveLetter\\PlatformBundle\\Entity\\Carte' . "\0" . 'pouvoir');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Carte $proxy) {
