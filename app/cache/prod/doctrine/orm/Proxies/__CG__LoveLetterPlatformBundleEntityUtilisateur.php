 ...
 */
class Utilisateur extends \LoveLetter\PlatformBundle\Entity\Utilisateur implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'LoveLetter\\PlatformBundle\\Entity\\Utilisateur' . "\0" . 'id', '' . "\0" . 'LoveLetter\\PlatformBundle\\Entity\\Utilisateur' . "\0" . 'pseudo', '' . "\0" . 'LoveLetter\\PlatformBundle\\Entity\\Utilisateur' . "\0" . 'mdp');
        }
